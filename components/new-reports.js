export default function NewReports() {
    return (
        ...
        >
            ...
            <div
                className='flex flex-col md:flex-row md:justify-center align-center max-w-full md:max-w-screen-lg mx-auto'>
                <div
                    className='relative h-56 w-56 bg-accent-10 box-shadow-accent-5 m-3 mx-auto text-center md:m-12 rounded-lg p-3 pt-8 text-xl  duration-200 transition-colors cursor-pointer'>
                    <div className='text-accent-5'>The GDS Covid 19 Global Key Findings Report</div>
                    <div
                        className='absolute bottom-0 left-0 right-0 w-full text-center text-accent-3 text-xl font-bold italic'>VIEW
                        REPORT
                    </div>
                </div>
                <div
                    className='relative h-56 w-56 bg-accent-10 box-shadow-accent-5 m-3 mx-auto text-center md:m-12 rounded-lg p-3 pt-8 text-xl  duration-200 transition-colors cursor-pointer'>
                    <div className='text-accent-5'>The GDS Covid 19 Global Executive Summary</div>
                    <div
                        className='absolute bottom-0 left-0 right-0 w-full text-center text-accent-3 text-xl font-bold italic'>DOWNLOAD
                        PDF
                    </div>
                </div>
            </div>
